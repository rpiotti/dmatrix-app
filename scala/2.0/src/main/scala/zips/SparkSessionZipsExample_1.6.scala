...
/**
  * spark-submit --class main.scala.zips.SparkSessionZipsExample_16 --master local[6] target/scala-2.10/main-scala-zips_2.10-1.0.jar <path_to_json_file>
  */
object SparkSessionZipsExample_16 {

  def main(args: Array[String]): Unit = {

    if (args.length != 1) {
      println("Usage: SparkSessionZipsExample_16 <path_to_json_file")
      System.exit(1)
    }
    //get the JSON file
    val jsonFile = args(0)
